...
# ========================= model ==========================
model = dict(
    model_cls="InternVideo2_CLIP_iso",
    vision_encoder=dict(
        ...
        depth=48,
        use_flash_attn=True,    # ISO: flash_attn 2.7.4 OK
        use_fused_rmsnorm=False,  # ISO: no dropout_layer_norm C++ ext
        use_fused_mlp=False,   # ISO: FusedMLP needs fused_dense_lib C++ ext
